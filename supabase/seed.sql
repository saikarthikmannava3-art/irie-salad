...
INSERT INTO delivery_zones (id, kitchen_id, name, slug, delivery_fee, is_active) VALUES
  ('d2000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 'Jubilee Hills',  'jubilee-hills',  0, true),
  ('d2000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000001', 'Banjara Hills',  'banjara-hills',  0, true),
  ('d2000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000001', 'Madhapur',        'madhapur',       0, true),
  ('d2000000-0000-0000-0000-000000000004', 'd1000000-0000-0000-0000-000000000001', 'Gachibowli',      'gachibowli',     0, true),
  ('d2000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000001', 'Kondapur',        'kondapur',       0, true),
  ('d2000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000001', 'Hitech City',     'hitech-city',    0, true)
...
INSERT INTO menu_categories (id, brand_id, name, slug, sort_order, is_active) VALUES
  ('e1000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'irie breakfast',                'irie-breakfast',               1,  true),
  ('e1000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'irie lunch thali',              'irie-lunch-thali',             2,  true),
  ('e1000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001', 'irie biryani',                  'irie-biryani',                 3,  true),
  ('e1000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000001', 'signature irie salad (350g)',    'signature-irie-salad-350',     4,  true),
  ('e1000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000001', 'signature irie salad (500g)',    'signature-irie-salad-500',     5,  true),
  ('e1000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000001', 'irie evening snack',            'irie-evening-snack',           6,  true),
  ('e1000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000001', 'Fresh Seasonal Fruit Bowl',     'fresh-seasonal-fruit-bowl',    7,  true),
  ('e1000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000001', 'irie dinner',                   'irie-dinner',                  8,  true),
  ('e1000000-0000-0000-0000-000000000009', 'b0000000-0000-0000-0000-000000000001', 'irie millet dinner',            'irie-millet-dinner',           9,  true),
  ('e1000000-0000-0000-0000-00000000000a', 'b0000000-0000-0000-0000-000000000001', 'Tropical Smoothie Bowl',        'tropical-smoothie-bowl',       10, true),
  ('e1000000-0000-0000-0000-00000000000b', 'b0000000-0000-0000-0000-000000000001', 'Coconut Overnight Oats',        'coconut-overnight-oats',       11, true),
  ('e1000000-0000-0000-0000-00000000000c', 'b0000000-0000-0000-0000-000000000001', 'Fresh Detox Juice',             'fresh-detox-juice',            12, true)
ON CONFLICT DO NOTHING;
...
INSERT INTO menu_items (id, brand_id, category_id, name, slug, description, short_desc, image_url, base_price, calories, is_customizable, has_daily_menu, short_name, is_active, sort_order) VALUES
  -- Breakfast
  ('e2000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000001',
  ...
  -- Lunch Thali
  ('e2000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000002',
  ...
  -- Biryani
  ('e2000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000003',
  ...
  -- Salad 350g
  ('e2000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000004',
  ...
  -- Salad 500g
  ('e2000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000005',
  ...
  -- Evening Snack
  ('e2000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000006',
  ...
  -- Fruit Bowl
  ('e2000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000007',
  ...
  -- Dinner
  ('e2000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000008',
  ...
  -- Millet Dinner
  ('e2000000-0000-0000-0000-000000000009', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-000000000009',
  ...
  ('e2000000-0000-0000-0000-00000000000a', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-00000000000a',
  ...
  ('e2000000-0000-0000-0000-00000000000b', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-00000000000b',
  ...
  ('e2000000-0000-0000-0000-00000000000c', 'b0000000-0000-0000-0000-000000000001', 'e1000000-0000-0000-0000-00000000000c',
...
INSERT INTO product_variants (id, menu_item_id, label, slug, variant_type, size, is_daily_menu, is_active, sort_order) VALUES
  ...
  ('e3000000-0000-0000-0000-000000000001', 'e2000000-0000-0000-0000-000000000001', 'Daily Breakfast',     'breakfast-daily',     'daily',   NULL,    true,  true, 1),

  -- Lunch Thali (single daily variant)
  ('e3000000-0000-0000-0000-000000000002', 'e2000000-0000-0000-0000-000000000002', 'Daily Lunch Thali',   'lunch-thali-daily',   'daily',   NULL,    true,  true, 1),

  -- Biryani (single daily variant)
  ('e3000000-0000-0000-0000-000000000003', 'e2000000-0000-0000-0000-000000000003', 'Daily Biryani/Pulao', 'biryani-daily',       'daily',   NULL,    true,  true, 1),

  -- Salad 350g — Tofu, Paneer, Garden
  ('e3000000-0000-0000-0000-000000000004', 'e2000000-0000-0000-0000-000000000004', 'Tofu 350g',           'salad-tofu-350',      'protein', '350g', false, true, 1),
  ('e3000000-0000-0000-0000-000000000005', 'e2000000-0000-0000-0000-000000000004', 'Paneer 350g',         'salad-paneer-350',    'protein', '350g', false, true, 2),
  ('e3000000-0000-0000-0000-000000000006', 'e2000000-0000-0000-0000-000000000004', 'Garden 350g',         'salad-garden-350',    'protein', '350g', false, true, 3),

  -- Salad 500g — Tofu, Paneer, Garden
  ('e3000000-0000-0000-0000-000000000007', 'e2000000-0000-0000-0000-000000000005', 'Tofu 500g',           'salad-tofu-500',      'protein', '500g', false, true, 1),
  ('e3000000-0000-0000-0000-000000000008', 'e2000000-0000-0000-0000-000000000005', 'Paneer 500g',         'salad-paneer-500',    'protein', '500g', false, true, 2),
  ('e3000000-0000-0000-0000-000000000009', 'e2000000-0000-0000-0000-000000000005', 'Garden 500g',         'salad-garden-500',    'protein', '500g', false, true, 3),

  -- Evening Snack (single daily variant)
  ('e3000000-0000-0000-0000-00000000000a', 'e2000000-0000-0000-0000-000000000006', 'Daily Eve Snack',     'eve-snack-daily',     'daily',   NULL,    true,  true, 1),

  -- Fruit Bowl (single daily variant)
  ('e3000000-0000-0000-0000-00000000000b', 'e2000000-0000-0000-0000-000000000007', 'Daily Fruit Bowl',    'fruit-bowl-daily',    'daily',   NULL,    true,  true, 1),

  -- Dinner (single daily variant)
  ('e3000000-0000-0000-0000-00000000000c', 'e2000000-0000-0000-0000-000000000008', 'Daily Dinner',        'dinner-daily',        'daily',   NULL,    true,  true, 1),

  -- Millet Dinner (single daily variant)
  ('e3000000-0000-0000-0000-00000000000d', 'e2000000-0000-0000-0000-000000000009', 'Daily Millet Dinner', 'millet-dinner-daily', 'daily',   NULL,    true,  true, 1),

  -- Smoothie Bowl (single variant)
  ('e3000000-0000-0000-0000-00000000000e', 'e2000000-0000-0000-0000-00000000000a', 'Smoothie Bowl',       'smoothie-default',    'default', NULL,    false, true, 1),

  -- Overnight Oats — Fruit, Chocolate, Seasonal
  ('e3000000-0000-0000-0000-00000000000f', 'e2000000-0000-0000-0000-00000000000b', 'Fruit Oats',          'oats-fruit',          'flavor',  NULL,    false, true, 1),
  ('e3000000-0000-0000-0000-000000000010', 'e2000000-0000-0000-0000-00000000000b', 'Chocolate Oats',      'oats-chocolate',      'flavor',  NULL,    false, true, 2),
  ('e3000000-0000-0000-0000-000000000011', 'e2000000-0000-0000-0000-00000000000b', 'Seasonal Oats',       'oats-seasonal',       'flavor',  NULL,    false, true, 3),

  -- Detox Juice (single variant)
  ('e3000000-0000-0000-0000-000000000012', 'e2000000-0000-0000-0000-00000000000c', 'Detox Juice',         'juice-default',       'default', NULL,    false, true, 1)
...
INSERT INTO product_addons (id, brand_id, name, slug, price, is_market_price, is_active, sort_order) VALUES
  ('e4000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'Extra Paneer',        'extra-paneer',     45.00, false, true, 1),
  ('e4000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001', 'Extra Tofu',          'extra-tofu',       45.00, false, true, 2),
  ('e4000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001', 'Protein Tikki (2 pcs)', 'protein-tikki', 25.00, false, true, 3),
  ('e4000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000001', 'Extra Seeds Mix',     'extra-seeds-mix',  25.00, false, true, 4),
  ('e4000000-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000001', 'Extra Avocado',       'extra-avocado',    45.00, false, true, 5),
  ('e4000000-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000001', 'Extra Roti (2 pcs)',  'extra-roti',       15.00, false, true, 6),
  ('e4000000-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000001', 'Extra Rice',          'extra-rice',       20.00, false, true, 7),
  ('e4000000-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000001', 'Extra Dal',           'extra-dal',        30.00, false, true, 8),
  ('e4000000-0000-0000-0000-000000000009', 'b0000000-0000-0000-0000-000000000001', 'Extra Raita',         'extra-raita',      25.00, false, true, 9)
ON CONFLICT (slug) DO NOTHING;
...
INSERT INTO product_addon_compatibility (addon_id, menu_item_id) VALUES
  ...
  ('e4000000-0000-0000-0000-000000000001', 'e2000000-0000-0000-0000-000000000004'),
  ('e4000000-0000-0000-0000-000000000001', 'e2000000-0000-0000-0000-000000000005'),
  ('e4000000-0000-0000-0000-000000000001', 'e2000000-0000-0000-0000-000000000002'),
  ('e4000000-0000-0000-0000-000000000001', 'e2000000-0000-0000-0000-000000000008'),

  -- Extra Tofu: salad-350, salad-500
  ('e4000000-0000-0000-0000-000000000002', 'e2000000-0000-0000-0000-000000000004'),
  ('e4000000-0000-0000-0000-000000000002', 'e2000000-0000-0000-0000-000000000005'),
  ...
  ('e4000000-0000-0000-0000-000000000003', 'e2000000-0000-0000-0000-000000000005'),
  ('e4000000-0000-0000-0000-000000000003', 'e2000000-0000-0000-0000-000000000002'),
  ('e4000000-0000-0000-0000-000000000003', 'e2000000-0000-0000-0000-000000000008'),

  -- Extra Seeds Mix: salad-350, salad-500, overnight-oats, millet-dinner
  ('e4000000-0000-0000-0000-000000000004', 'e2000000-0000-0000-0000-000000000004'),
  ('e4000000-0000-0000-0000-000000000004', 'e2000000-0000-0000-0000-000000000005'),
  ('e4000000-0000-0000-0000-000000000004', 'e2000000-0000-0000-0000-00000000000b'),
  ('e4000000-0000-0000-0000-000000000004', 'e2000000-0000-0000-0000-000000000009'),

  -- Extra Avocado: salad-350, salad-500
  ('e4000000-0000-0000-0000-000000000005', 'e2000000-0000-0000-0000-000000000004'),
  ('e4000000-0000-0000-0000-000000000005', 'e2000000-0000-0000-0000-000000000005'),

  -- Extra Roti: lunch-thali, dinner
  ('e4000000-0000-0000-0000-000000000006', 'e2000000-0000-0000-0000-000000000002'),
  ('e4000000-0000-0000-0000-000000000006', 'e2000000-0000-0000-0000-000000000008'),

  -- Extra Rice: lunch-thali, biryani, dinner
  ('e4000000-0000-0000-0000-000000000007', 'e2000000-0000-0000-0000-000000000002'),
  ('e4000000-0000-0000-0000-000000000007', 'e2000000-0000-0000-0000-000000000003'),
  ('e4000000-0000-0000-0000-000000000007', 'e2000000-0000-0000-0000-000000000008'),

  -- Extra Dal: lunch-thali, dinner
  ('e4000000-0000-0000-0000-000000000008', 'e2000000-0000-0000-0000-000000000002'),
  ('e4000000-0000-0000-0000-000000000008', 'e2000000-0000-0000-0000-000000000008'),

  -- Extra Raita: lunch-thali, biryani, dinner
  ('e4000000-0000-0000-0000-000000000009', 'e2000000-0000-0000-0000-000000000002'),
  ('e4000000-0000-0000-0000-000000000009', 'e2000000-0000-0000-0000-000000000003'),
  ('e4000000-0000-0000-0000-000000000009', 'e2000000-0000-0000-0000-000000000008')
...
INSERT INTO product_pricing (variant_id, plan_duration, price) VALUES
  ...
  ('e3000000-0000-0000-0000-000000000001', 'single', 149),
  ('e3000000-0000-0000-0000-000000000001', '12',     134),
  ('e3000000-0000-0000-0000-000000000001', '24',     119),
  ('e3000000-0000-0000-0000-000000000001', '48',     112),

  -- Lunch Thali: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-000000000002', 'single', 249),
  ('e3000000-0000-0000-0000-000000000002', '12',     224),
  ('e3000000-0000-0000-0000-000000000002', '24',     199),
  ('e3000000-0000-0000-0000-000000000002', '48',     187),

  -- Biryani: 279 / 251 / 223 / 209
  ('e3000000-0000-0000-0000-000000000003', 'single', 279),
  ('e3000000-0000-0000-0000-000000000003', '12',     251),
  ('e3000000-0000-0000-0000-000000000003', '24',     223),
  ('e3000000-0000-0000-0000-000000000003', '48',     209),

  -- Salad Tofu 350g: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-000000000004', 'single', 249),
  ('e3000000-0000-0000-0000-000000000004', '12',     224),
  ('e3000000-0000-0000-0000-000000000004', '24',     199),
  ('e3000000-0000-0000-0000-000000000004', '48',     187),

  -- Salad Paneer 350g: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-000000000005', 'single', 249),
  ('e3000000-0000-0000-0000-000000000005', '12',     224),
  ('e3000000-0000-0000-0000-000000000005', '24',     199),
  ('e3000000-0000-0000-0000-000000000005', '48',     187),

  -- Salad Garden 350g: 229 / 206 / 183 / 172
  ('e3000000-0000-0000-0000-000000000006', 'single', 229),
  ('e3000000-0000-0000-0000-000000000006', '12',     206),
  ('e3000000-0000-0000-0000-000000000006', '24',     183),
  ('e3000000-0000-0000-0000-000000000006', '48',     172),

  -- Salad Tofu 500g: 299 / 269 / 239 / 224
  ('e3000000-0000-0000-0000-000000000007', 'single', 299),
  ('e3000000-0000-0000-0000-000000000007', '12',     269),
  ('e3000000-0000-0000-0000-000000000007', '24',     239),
  ('e3000000-0000-0000-0000-000000000007', '48',     224),

  -- Salad Paneer 500g: 299 / 269 / 239 / 224
  ('e3000000-0000-0000-0000-000000000008', 'single', 299),
  ('e3000000-0000-0000-0000-000000000008', '12',     269),
  ('e3000000-0000-0000-0000-000000000008', '24',     239),
  ('e3000000-0000-0000-0000-000000000008', '48',     224),

  -- Salad Garden 500g: 279 / 251 / 223 / 209
  ('e3000000-0000-0000-0000-000000000009', 'single', 279),
  ('e3000000-0000-0000-0000-000000000009', '12',     251),
  ('e3000000-0000-0000-0000-000000000009', '24',     223),
  ('e3000000-0000-0000-0000-000000000009', '48',     209),

  -- Evening Snack: 129 / 116 / 103 / 97
  ('e3000000-0000-0000-0000-00000000000a', 'single', 129),
  ('e3000000-0000-0000-0000-00000000000a', '12',     116),
  ('e3000000-0000-0000-0000-00000000000a', '24',     103),
  ('e3000000-0000-0000-0000-00000000000a', '48',      97),

  -- Fruit Bowl: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-00000000000b', 'single', 249),
  ('e3000000-0000-0000-0000-00000000000b', '12',     224),
  ('e3000000-0000-0000-0000-00000000000b', '24',     199),
  ('e3000000-0000-0000-0000-00000000000b', '48',     187),

  -- Dinner: 219 / 197 / 175 / 165
  ('e3000000-0000-0000-0000-00000000000c', 'single', 219),
  ('e3000000-0000-0000-0000-00000000000c', '12',     197),
  ('e3000000-0000-0000-0000-00000000000c', '24',     175),
  ('e3000000-0000-0000-0000-00000000000c', '48',     165),

  -- Millet Dinner: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-00000000000d', 'single', 249),
  ('e3000000-0000-0000-0000-00000000000d', '12',     224),
  ('e3000000-0000-0000-0000-00000000000d', '24',     199),
  ('e3000000-0000-0000-0000-00000000000d', '48',     187),

  -- Smoothie Bowl: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-00000000000e', 'single', 249),
  ('e3000000-0000-0000-0000-00000000000e', '12',     224),
  ('e3000000-0000-0000-0000-00000000000e', '24',     199),
  ('e3000000-0000-0000-0000-00000000000e', '48',     187),

  -- Overnight Oats Fruit: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-00000000000f', 'single', 249),
  ('e3000000-0000-0000-0000-00000000000f', '12',     224),
  ('e3000000-0000-0000-0000-00000000000f', '24',     199),
  ('e3000000-0000-0000-0000-00000000000f', '48',     187),

  -- Overnight Oats Chocolate: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-000000000010', 'single', 249),
  ('e3000000-0000-0000-0000-000000000010', '12',     224),
  ('e3000000-0000-0000-0000-000000000010', '24',     199),
  ('e3000000-0000-0000-0000-000000000010', '48',     187),

  -- Overnight Oats Seasonal: 249 / 224 / 199 / 187
  ('e3000000-0000-0000-0000-000000000011', 'single', 249),
  ('e3000000-0000-0000-0000-000000000011', '12',     224),
  ('e3000000-0000-0000-0000-000000000011', '24',     199),
  ('e3000000-0000-0000-0000-000000000011', '48',     187),

  -- Detox Juice: 139 / 0 / 0 / 0 (single purchase only)
  ('e3000000-0000-0000-0000-000000000012', 'single', 139),
  ('e3000000-0000-0000-0000-000000000012', '12',       0),
  ('e3000000-0000-0000-0000-000000000012', '24',       0),
  ('e3000000-0000-0000-0000-000000000012', '48',       0)
...
INSERT INTO plans (id, brand_id, name, slug, duration_days, meals_per_day, price_per_meal, total_price, discount_pct, description, features, is_trial, is_active, sort_order) VALUES
  ('e5000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001',
  ...
  ('e5000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000001',
  ...
  ('e5000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000001',
  ...
  ('e5000000-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000001',
...
INSERT INTO recipes (id, menu_item_id, version, instructions, prep_time_mins, is_current) VALUES
  ...
  ('e6000000-0000-0000-0000-000000000001', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "pesarattu",
  ...
  ('e6000000-0000-0000-0000-000000000002', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "idli-sambar",
  ...
  ('e6000000-0000-0000-0000-000000000003', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "ven-pongal",
  ...
  ('e6000000-0000-0000-0000-000000000004', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "vegetable-upma",
  ...
  ('e6000000-0000-0000-0000-000000000005', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "poha",
  ...
  ('e6000000-0000-0000-0000-000000000006', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "masala-dosa",
  ...
  ('e6000000-0000-0000-0000-000000000007', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
     "slug": "aloo-paratha",
  ...
  ('e6000000-0000-0000-0000-000000000008', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000009', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-00000000000a', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-00000000000b', 'e2000000-0000-0000-0000-000000000001', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000101', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
     "slug": "dal-rice",
  ...
  ('e6000000-0000-0000-0000-000000000102', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
     "slug": "rajma-chawal",
  ...
  ('e6000000-0000-0000-0000-000000000103', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
     "slug": "chole-rice",
  ...
  ('e6000000-0000-0000-0000-000000000104', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
     "slug": "sambar-rice",
  ...
  ('e6000000-0000-0000-0000-000000000105', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
     "slug": "millet-khichdi",
  ...
  ('e6000000-0000-0000-0000-000000000106', 'e2000000-0000-0000-0000-000000000003', 1,
   '{
     "slug": "veg-biryani",
  ...
  ('e6000000-0000-0000-0000-000000000107', 'e2000000-0000-0000-0000-000000000003', 1,
   '{
     "slug": "veg-pulao",
  ...
  ('e6000000-0000-0000-0000-000000000108', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000109', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-00000000010a', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-00000000010b', 'e2000000-0000-0000-0000-000000000009', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-00000000010c', 'e2000000-0000-0000-0000-000000000002', 1,
   '{
     "slug": "bisi-bele-bath",
  ...
  ('e6000000-0000-0000-0000-000000000201', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "sprout-chaat",
  ...
  ('e6000000-0000-0000-0000-000000000202', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "dhokla",
  ...
  ('e6000000-0000-0000-0000-000000000203', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "evening-idli",
  ...
  -- S04: Masala Corn Cup
  ('e6000000-0000-0000-0000-000000000204', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
  ...
  -- S05: Chana Sundal
  ('e6000000-0000-0000-0000-000000000205', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "sundal",
     "name": "Chana Sundal",
     "shortName": "Sundal",
  ...
  ('e6000000-0000-0000-0000-000000000206', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "makhana-snack",
  ...
  ('e6000000-0000-0000-0000-000000000207', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000208', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "fruit-chaat",
  ...
  ('e6000000-0000-0000-0000-000000000209', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "samosa-chaat",
  ...
  -- S10: Pani Puri Kit
  ('e6000000-0000-0000-0000-00000000020a', 'e2000000-0000-0000-0000-000000000006', 1,
   '{
     "slug": "pani-puri-kit",
     "name": "Pani Puri Kit",
     "shortName": "Pani Puri",
  ...
  ('e6000000-0000-0000-0000-000000000301', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
     "slug": "light-khichdi",
  ...
  ('e6000000-0000-0000-0000-000000000302', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000303', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
     "slug": "dinner-dosa",
  ...
  ('e6000000-0000-0000-0000-000000000304', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000305', 'e2000000-0000-0000-0000-000000000009', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000306', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
     "slug": "dinner-pongal",
  ...
  ('e6000000-0000-0000-0000-000000000307', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000308', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
     "slug": "rice-rasam",
  ...
  ('e6000000-0000-0000-0000-000000000309', 'e2000000-0000-0000-0000-000000000009', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-00000000030a', 'e2000000-0000-0000-0000-000000000008', 1,
   '{
     "slug": "curd-rice",
  ...
  ('e6000000-0000-0000-0000-000000000401', 'e2000000-0000-0000-0000-000000000004', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000402', 'e2000000-0000-0000-0000-00000000000a', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000403', 'e2000000-0000-0000-0000-00000000000b', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000404', 'e2000000-0000-0000-0000-000000000007', 1,
   '{
  ...
  ('e6000000-0000-0000-0000-000000000405', 'e2000000-0000-0000-0000-00000000000c', 1,
   '{
